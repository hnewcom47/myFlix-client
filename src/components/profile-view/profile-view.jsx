...
export class ProfileView extends React.Component {
    ...
    getUserData(token) {
        ...
        axios.get(`https://movies4you-application.herokuapp.com/users/${username}`, {
    ...
    deregisterUser() {
        ...
        if (confirm('Please confirm that you want to delete your profile.')) {
            return (
                axios.delete(`https://movies4you-application.herokuapp.com/users/${username}`, {
    ...
    deleteFavoriteMovies(movie) {
        const username = localStorage.getItem('user');
        const accessToken = localStorage.getItem('token');
        axios.delete(`https://movies4you-application.herokuapp.com/users/${username}/Movies/${movie._id}`, {
            headers: { Authorization: `Bearer ${accessToken}` }
        })
            .then((response) => {
                console.log(response);
