...
export class MovieCard extends React.Component {
    ...
    addFavorite = () => {
        ...
        axios({
            method: 'post',
            url: `https://movies4you-application.herokuapp.com/users/${this.state.username}/Movies/${this.state.movie._id}`,
    ...
    removeFavorite = () => {
        ...
        axios.delete(`https://movies4you-application.herokuapp.com/users/${this.state.username}/Movies/${this.state.movie._id}`, {
            headers: { Authorization: `Bearer ${this.state.userToken}` },
        })
            .then((response) => {
